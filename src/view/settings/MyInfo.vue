      ...
      <el-row :gutter="15">
        <el-col :span="8">
          <el-form-item label="头像" prop="avatar">
            <CoverUpload v-model="formData.avatar" @click="saveAvatar"></CoverUpload>
          </el-form-item>
          ...
          <el-form-item label="密码">
            <a class="a-link" href="javascript:void(0)" @click="showUpdatePassword">修改密码</a>
          </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="重复密码" prop="rePassword">
          <el-input placeholder="请再次输入密码" v-model="passwordFormData.rePassword" type="password"></el-input>
        </el-form-item>
      </el-form>
    </Dialog>
  </div>
