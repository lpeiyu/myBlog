  ...
  <div class="layout">
                ...
                <span class="menu-title-p" @click="openClose(index)">
                  ...
                  <i
                    :class="[
                      'iconfont',
                      'open-close',
                      menu.open ? 'icon-31shouqi' : 'icon-open',
                    ]"
                  ></i>
                </span>
    ...
    >
      <div class="progress-container">
        ...
        <div class="success" v-if="progressInfo.progress==100 && progressInfo.result==1">发布成功</div>
        <div class="success" v-if="progressInfo.progress==100 && progressInfo.result==0">
...
const getUserInfo=async () =>{
  ...
  userInfo.value.avatar=proxy.globalInfo.imgUrl + result.data.avatar
}
getUserInfo()
...
const progressInfo = reactive({ progress:0 })
let checkTimer=null
